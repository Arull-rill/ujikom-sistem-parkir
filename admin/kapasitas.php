                ...
                <tr>
                    <form method="POST">
                        ...
                        <td>
                            ...
                            <input type="number" name="total_slot" value="<?php echo $row['total_slot']; ?>" required>
                        </td>
                        <td><?php echo $row['slot_terisi']; ?></td>
                        <td><?php echo $row['total_slot'] - $row['slot_terisi']; ?></td>
                        <td>
